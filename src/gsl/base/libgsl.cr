...
lib LibGSL
  ...
  $gsl_integration_fixed_legendre : IntegrationFixedType*
  $gsl_integration_fixed_chebyshev : IntegrationFixedType*
  $gsl_integration_fixed_gegenbauer : IntegrationFixedType*
  $gsl_integration_fixed_jacobi : IntegrationFixedType*
  $gsl_integration_fixed_laguerre : IntegrationFixedType*
  $gsl_integration_fixed_hermite : IntegrationFixedType*
  $gsl_integration_fixed_exponential : IntegrationFixedType*
  $gsl_integration_fixed_rational : IntegrationFixedType*
  $gsl_integration_fixed_chebyshev2 : IntegrationFixedType*
  $gsl_interp_linear : InterpType*
  $gsl_interp_polynomial : InterpType*
  $gsl_interp_cspline : InterpType*
  $gsl_interp_cspline_periodic : InterpType*
  $gsl_interp_akima : InterpType*
  $gsl_interp_akima_periodic : InterpType*
  $gsl_interp_steffen : InterpType*
  $gsl_interp2d_bilinear : Interp2dType*
  $gsl_interp2d_bicubic : Interp2dType*
  $gsl_message_mask : LibC::UInt
  $gsl_min_fminimizer_goldensection : MinFminimizerType*
  $gsl_min_fminimizer_brent : MinFminimizerType*
  $gsl_min_fminimizer_quad_golden : MinFminimizerType*
  $gsl_rng_borosh13 : RngType*
  $gsl_rng_coveyou : RngType*
  $gsl_rng_cmrg : RngType*
  $gsl_rng_fishman18 : RngType*
  $gsl_rng_fishman20 : RngType*
  $gsl_rng_fishman2x : RngType*
  $gsl_rng_gfsr4 : RngType*
  $gsl_rng_knuthran : RngType*
  $gsl_rng_knuthran2 : RngType*
  $gsl_rng_knuthran2002 : RngType*
  $gsl_rng_lecuyer21 : RngType*
  $gsl_rng_minstd : RngType*
  $gsl_rng_mrg : RngType*
  $gsl_rng_mt19937 : RngType*
  $gsl_rng_mt19937_1999 : RngType*
  $gsl_rng_mt19937_1998 : RngType*
  $gsl_rng_r250 : RngType*
  $gsl_rng_ran0 : RngType*
  $gsl_rng_ran1 : RngType*
  $gsl_rng_ran2 : RngType*
  $gsl_rng_ran3 : RngType*
  $gsl_rng_rand : RngType*
  $gsl_rng_rand48 : RngType*
  $gsl_rng_random128_bsd : RngType*
  $gsl_rng_random128_glibc2 : RngType*
  $gsl_rng_random128_libc5 : RngType*
  $gsl_rng_random256_bsd : RngType*
  $gsl_rng_random256_glibc2 : RngType*
  $gsl_rng_random256_libc5 : RngType*
  $gsl_rng_random32_bsd : RngType*
  $gsl_rng_random32_glibc2 : RngType*
  $gsl_rng_random32_libc5 : RngType*
  $gsl_rng_random64_bsd : RngType*
  $gsl_rng_random64_glibc2 : RngType*
  $gsl_rng_random64_libc5 : RngType*
  $gsl_rng_random8_bsd : RngType*
  $gsl_rng_random8_glibc2 : RngType*
  $gsl_rng_random8_libc5 : RngType*
  $gsl_rng_random_bsd : RngType*
  $gsl_rng_random_glibc2 : RngType*
  $gsl_rng_random_libc5 : RngType*
  $gsl_rng_randu : RngType*
  $gsl_rng_ranf : RngType*
  $gsl_rng_ranlux : RngType*
  $gsl_rng_ranlux389 : RngType*
  $gsl_rng_ranlxd1 : RngType*
  $gsl_rng_ranlxd2 : RngType*
  $gsl_rng_ranlxs0 : RngType*
  $gsl_rng_ranlxs1 : RngType*
  $gsl_rng_ranlxs2 : RngType*
  $gsl_rng_ranmar : RngType*
  $gsl_rng_slatec : RngType*
  $gsl_rng_taus : RngType*
  $gsl_rng_taus2 : RngType*
  $gsl_rng_taus113 : RngType*
  $gsl_rng_transputer : RngType*
  $gsl_rng_tt800 : RngType*
  $gsl_rng_uni : RngType*
  $gsl_rng_uni32 : RngType*
  $gsl_rng_vax : RngType*
  $gsl_rng_waterman14 : RngType*
  $gsl_rng_zuf : RngType*
  $gsl_rng_default : RngType*
  $gsl_rng_default_seed : LibC::ULong
  $gsl_multifit_robust_default : MultifitRobustType*
  $gsl_multifit_robust_bisquare : MultifitRobustType*
  $gsl_multifit_robust_cauchy : MultifitRobustType*
  $gsl_multifit_robust_fair : MultifitRobustType*
  $gsl_multifit_robust_huber : MultifitRobustType*
  $gsl_multifit_robust_ols : MultifitRobustType*
  $gsl_multifit_robust_welsch : MultifitRobustType*
  $gsl_multifit_nlinear_trust : MultifitNlinearType*
  $gsl_multifit_nlinear_trs_lm : MultifitNlinearTrs*
  $gsl_multifit_nlinear_trs_lmaccel : MultifitNlinearTrs*
  $gsl_multifit_nlinear_trs_dogleg : MultifitNlinearTrs*
  $gsl_multifit_nlinear_trs_ddogleg : MultifitNlinearTrs*
  $gsl_multifit_nlinear_trs_subspace2D : MultifitNlinearTrs*
  $gsl_multifit_nlinear_scale_levenberg : MultifitNlinearScale*
  $gsl_multifit_nlinear_scale_marquardt : MultifitNlinearScale*
  $gsl_multifit_nlinear_scale_more : MultifitNlinearScale*
  $gsl_multifit_nlinear_solver_cholesky : MultifitNlinearSolver*
  $gsl_multifit_nlinear_solver_qr : MultifitNlinearSolver*
  $gsl_multifit_nlinear_solver_svd : MultifitNlinearSolver*
  $gsl_multifit_fdfsolver_lmsder : MultifitFdfsolverType*
  $gsl_multifit_fdfsolver_lmder : MultifitFdfsolverType*
  $gsl_multifit_fdfsolver_lmniel : MultifitFdfsolverType*
  $gsl_multilarge_linear_normal : MultilargeLinearType*
  $gsl_multilarge_linear_tsqr : MultilargeLinearType*
  $gsl_multilarge_nlinear_trust : MultilargeNlinearType*
  $gsl_multilarge_nlinear_trs_lm : MultilargeNlinearTrs*
  $gsl_multilarge_nlinear_trs_lmaccel : MultilargeNlinearTrs*
  $gsl_multilarge_nlinear_trs_dogleg : MultilargeNlinearTrs*
  $gsl_multilarge_nlinear_trs_ddogleg : MultilargeNlinearTrs*
  $gsl_multilarge_nlinear_trs_subspace2D : MultilargeNlinearTrs*
  $gsl_multilarge_nlinear_trs_cgst : MultilargeNlinearTrs*
  $gsl_multilarge_nlinear_scale_levenberg : MultilargeNlinearScale*
  $gsl_multilarge_nlinear_scale_marquardt : MultilargeNlinearScale*
  $gsl_multilarge_nlinear_scale_more : MultilargeNlinearScale*
  $gsl_multilarge_nlinear_solver_cholesky : MultilargeNlinearSolver*
  $gsl_multilarge_nlinear_solver_none : MultilargeNlinearSolver*
  $gsl_multimin_fdfminimizer_steepest_descent : MultiminFdfminimizerType*
  $gsl_multimin_fdfminimizer_conjugate_pr : MultiminFdfminimizerType*
  $gsl_multimin_fdfminimizer_conjugate_fr : MultiminFdfminimizerType*
  $gsl_multimin_fdfminimizer_vector_bfgs : MultiminFdfminimizerType*
  $gsl_multimin_fdfminimizer_vector_bfgs2 : MultiminFdfminimizerType*
  $gsl_multimin_fminimizer_nmsimplex : MultiminFminimizerType*
  $gsl_multimin_fminimizer_nmsimplex2 : MultiminFminimizerType*
  $gsl_multimin_fminimizer_nmsimplex2rand : MultiminFminimizerType*
  $gsl_multiroot_fsolver_dnewton : MultirootFsolverType*
  $gsl_multiroot_fsolver_broyden : MultirootFsolverType*
  $gsl_multiroot_fsolver_hybrid : MultirootFsolverType*
  $gsl_multiroot_fsolver_hybrids : MultirootFsolverType*
  $gsl_multiroot_fdfsolver_newton : MultirootFdfsolverType*
  $gsl_multiroot_fdfsolver_gnewton : MultirootFdfsolverType*
  $gsl_multiroot_fdfsolver_hybridj : MultirootFdfsolverType*
  $gsl_multiroot_fdfsolver_hybridsj : MultirootFdfsolverType*
  $gsl_odeiv2_step_rk2 : Odeiv2StepType*
  $gsl_odeiv2_step_rk4 : Odeiv2StepType*
  $gsl_odeiv2_step_rkf45 : Odeiv2StepType*
  $gsl_odeiv2_step_rkck : Odeiv2StepType*
  $gsl_odeiv2_step_rk8pd : Odeiv2StepType*
  $gsl_odeiv2_step_rk2imp : Odeiv2StepType*
  $gsl_odeiv2_step_rk4imp : Odeiv2StepType*
  $gsl_odeiv2_step_bsimp : Odeiv2StepType*
  $gsl_odeiv2_step_rk1imp : Odeiv2StepType*
  $gsl_odeiv2_step_msadams : Odeiv2StepType*
  $gsl_odeiv2_step_msbdf : Odeiv2StepType*
  $gsl_odeiv_step_rk2 : OdeivStepType*
  $gsl_odeiv_step_rk4 : OdeivStepType*
  $gsl_odeiv_step_rkf45 : OdeivStepType*
  $gsl_odeiv_step_rkck : OdeivStepType*
  $gsl_odeiv_step_rk8pd : OdeivStepType*
  $gsl_odeiv_step_rk2imp : OdeivStepType*
  $gsl_odeiv_step_rk2simp : OdeivStepType*
  $gsl_odeiv_step_rk4imp : OdeivStepType*
  $gsl_odeiv_step_bsimp : OdeivStepType*
  $gsl_odeiv_step_gear1 : OdeivStepType*
  $gsl_odeiv_step_gear2 : OdeivStepType*
  $gsl_qrng_niederreiter_2 : QrngType*
  $gsl_qrng_sobol : QrngType*
  $gsl_qrng_halton : QrngType*
  $gsl_qrng_reversehalton : QrngType*
  $gsl_root_fsolver_bisection : RootFsolverType*
  $gsl_root_fsolver_brent : RootFsolverType*
  $gsl_root_fsolver_falsepos : RootFsolverType*
  $gsl_root_fdfsolver_newton : RootFdfsolverType*
  $gsl_root_fdfsolver_secant : RootFdfsolverType*
  $gsl_root_fdfsolver_steffenson : RootFdfsolverType*
  $gsl_splinalg_itersolve_gmres : SplinalgItersolveType*
  $gsl_version : LibC::Char*
  $gsl_wavelet_daubechies : WaveletType*
  $gsl_wavelet_daubechies_centered : WaveletType*
  $gsl_wavelet_haar : WaveletType*
  $gsl_wavelet_haar_centered : WaveletType*
  $gsl_wavelet_bspline : WaveletType*
  $gsl_wavelet_bspline_centered : WaveletType*
end
